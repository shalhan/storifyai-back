package com.storifyai.api.infra.adapter.driver.http.filter

import com.storifyai.api.infra.adapter.driver.http.wrapper.CustomHttpServletRequestWrapper
...
class RequestCachingFilter : OncePerRequestFilter() {
    ...
    override fun doFilterInternal(
        ...
        println("authorizationHttpConfig $authorizationHttpConfig")
